 ...
 *
 * @implNote  Subclasses need to override {@link #supports(Database)}.
 *      If {@code listLocks} necessary to provide actual info,
 *      {@link #usedLock(Connection)} has to be overridden, also.
 */
